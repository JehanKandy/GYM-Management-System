<?php 
    ...
    function add_product($p_name, $p_price, $p_qty, $p_stock, $p_desc){
        ...
        if($check_prodcuts_nor > 0){
            ...
            $insert_product = "INSERT INTO shop(p_name,p_desc,p_price,qty,is_stock,status,img_status,date)VALUES('$p_name','$p_desc','$p_price','$p_qty','$p_stock',1,0,NOW())";
        ...
        if($check_product_nor > 0){
            ...
            <img src='../../upload/".$check_product_row['product_img']."' class='product-image' alt='p_img'>
                ...
                <div class='product-add-grid'>               
                        ...
                        <span>
                                Product Description : 
                                <textarea class='form-control' id='exampleFormControlTextarea1' rows='3' name='update_pdesc' value='".$check_product_row['']."'></textarea>
                            </span>
                        </div>
                        <div class='item-add6'>
                            <span>
